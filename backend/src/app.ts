...
export function createApp() {
  ...
  customer.use("/servers/:serverId/files", filesRouter);
  customer.use("/servers", serversRouter);
  customer.use("/transfers", transfersRouter);
  customer.use("/backups", backupsRouter);
  customer.use("/deployments", deploymentsRouter);
  customer.use("/automations", automationsRouter);
  customer.use("/monitoring", monitoringRouter);
  customer.use("/activity", activityRouter);
