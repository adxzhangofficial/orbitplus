...
export function TeamPage() {
  ...
  const [sendInvite, sendInvitePending] = useAction(sendInviteRequest);
  ...
  async function removeRequest(member: TeamRow) {
    if (live) {
