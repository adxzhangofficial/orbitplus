...
export function DeploymentsPage() {
  ...
  const [deploy, deployPending] = useAction(deployRequest);
  const [redeploy, redeployPending] = useAction(redeployRequest);
  const [rollback, rollbackPending] = useAction(rollbackRequest);
  ...
  async function rollbackRequest(item: DeploymentRow) {
  ...
  async function redeployRequest(item: DeploymentRow) {
