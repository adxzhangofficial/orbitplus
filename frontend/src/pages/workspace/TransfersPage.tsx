...
export function TransfersPage() {
  ...
  const [createTransfer, createTransferPending] = useAction(createTransferRequest);
  const [cancel, cancelPending] = useAction(cancelRequest);
