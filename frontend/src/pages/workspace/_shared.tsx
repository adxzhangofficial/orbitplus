...
/**
 * The page container used by the workspace overview, servers, and server
 * detail pages.
 *
 * Those three set this on their own root element. Every other workspace page
 * rendered directly into the shell with no max width and no padding, so they
 * sat flush against the sidebar and the top of the viewport while the overview
 * was inset. Same measurements, applied in one place.
 *
 * The file explorer deliberately does not use this: it is a full-bleed pane.
 */
export const pageContainerClass = "mx-auto max-w-[1500px] space-y-8 px-4 py-5 sm:px-6 md:px-8 md:py-7";
