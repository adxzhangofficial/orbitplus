...
export function AutomationsPage() {
  ...
  const [create, createPending] = useAction(createRequest);
  const [duplicate, duplicatePending] = useAction(duplicateRequest);
  ...
  async function duplicateRequest(item: Automation) {
  ...
  async function removeRequest(item: Automation) {
