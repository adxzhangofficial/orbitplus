...
export function NotificationsPage() {
  ...
  const [mark, markPending] = useAction(markRequest);

  async function markRequest(item: Notification, read: boolean) {
